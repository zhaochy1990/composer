    ...
    return (
        <div className="relative" ref={ref}>
            ...
            >
                Project
                {isFiltering && (
                    <span className="bg-teal-200 text-teal-800 dark:bg-teal-800 dark:text-teal-200 px-1 rounded text-[10px]">
            ...
            {open && (
                <div className="absolute top-full left-0 mt-1 z-50 w-56 bg-bg-surface border border-border-primary rounded-md shadow-lg py-1">
                    <div className="flex items-center justify-between px-3 py-1.5 border-b border-border-primary">
                        <span className="text-xs text-text-muted">Filter by project</span>
                        {isFiltering && (
                            <button
                                type="button"
                                onClick={clearAll}
                    ...
                    <div className="max-h-64 overflow-y-auto">
                        <label className="flex items-center gap-2 px-3 py-1.5 text-sm cursor-pointer hover:bg-bg-elevated">
                            <input
                                type="checkbox"
                            ...
                            />
                            <span className="text-text-muted italic">No project</span>
                        </label>
                        ...
                        {projects.map(p => (
                            <label
                                key={p.id}
                                className="flex items-center gap-2 px-3 py-1.5 text-sm cursor-pointer hover:bg-bg-elevated"
                            >
                                <input
                                    type="checkbox"
